    ...
    return (
        <div className="min-h-screen bg-[#f8fafc] flex flex-col font-sans relative overflow-hidden">
            ...
            <div className="bg-white/60 backdrop-blur-2xl border-b border-white shadow-[0_4px_30px_rgba(0,0,0,0.03)] py-4 sticky top-0 z-40 transition-all">
                <div className="w-[96%] max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between relative z-10">
            ...
            <main className="w-[96%] max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-10 relative z-10">
            ...
            <div className="mb-10 text-center lg:text-left">
                ...
                <div className="grid grid-cols-1 xl:grid-cols-12 gap-8 xl:gap-10">
                    ...
                    {/* ── Donation History ───────────────────── */}
                    <section className="xl:col-span-4 2xl:col-span-3">
